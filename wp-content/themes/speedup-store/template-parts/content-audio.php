...
<article class="page-box p-2 mt-0 mx-2 mb-3">
  ...
  <?php }?>
  <?php if(get_theme_mod('speedup_store_blog_post_description_option') != 'Full Content'){ ?>
  ...
  <div class="new-text">
    ...
    <?php }
    if(get_theme_mod('speedup_store_blog_post_description_option', 'Excerpt Content') == 'Excerpt Content'){ ?>
      <?php if(get_the_excerpt()) { ?>
        <div class="entry-content"><p><?php $excerpt = get_the_excerpt(); echo esc_html( speedup_store_string_limit_words( $excerpt, esc_attr(get_theme_mod('speedup_store_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('speedup_store_post_suffix_option','...') ); ?></p></div>
      <?php }?>
    <?php }?>
    <?php if( get_theme_mod('speedup_store_button_text','Read More') != ''){ ?>
      <div class="second-border text-end my-4 mx-0">
        <a href="<?php echo esc_url( get_permalink() );?>" class="py-3 px-4" title="<?php esc_attr_e( 'Read More', 'speedup-store' ); ?>"><?php echo esc_html(get_theme_mod('speedup_store_button_text','Read More'));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('speedup_store_button_text','Read More'));?></span></a>
      </div>
    <?php }?>
  </div>
